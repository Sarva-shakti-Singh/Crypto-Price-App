...
@st.cache_data
def load_data():
    # Dummy data since scraping is broken due to site changes
    data = {
        'coin_name': ['bitcoin', 'ethereum', 'tether', 'binance-coin', 'solana'],
        'coin_symbol': ['BTC', 'ETH', 'USDT', 'BNB', 'SOL'],
        'market_cap': [1000000000000, 500000000000, 100000000000, 50000000000, 20000000000],
        'percent_change_1h': [0.5, 1.2, 0.0, -0.3, 2.1],
        'percent_change_24h': [2.3, -1.5, 0.1, 3.4, -0.8],
        'percent_change_7d': [5.6, 4.2, -0.2, 7.8, 10.5],
        'price': [50000, 3000, 1.0, 400, 100],
        'volume_24h': [20000000000, 15000000000, 50000000000, 2000000000, 5000000000]
    }
